...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs
        .sendForm('service_ldmi30y', 'template_naj7ct3', form.current, {
          publicKey: 'L7sPqpFF85h1eJK13',
        })
        .then(
          () => {
            setSuccess(true)
        ...
        <motion.div className="contact" ref={ref} variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="contactItem" variants={variants}>
                    ...
                    <motion.span variants={variants}>teoperalez@gmail.com</motion.span>
                </motion.div>
                <motion.div className="contactItem" variants={variants}>
                    <motion.h2 variants={variants}>Phone</motion.h2>
                    <motion.span variants={variants}>+81-070-8553-6336</motion.span>
                </motion.div>
                <motion.div className="contactItem" variants={variants}>
                    <motion.h2 variants={variants}>Discord</motion.h2>
                    <motion.span variants={variants}>@rbypokemonchallenges</motion.span>
                </motion.div>
            </motion.div>
            ...
            C32.666,7.326,25.339,0,16.333,0z"
                ...
                transition={{ 
                    ...
                    {error && <p>ERROR: Email could not be sent!</p>}
